...
s0_put_next_output_key = <Control><Alt><Super>n
s0_put_next_output_button = Disabled
s0_put_previous_output_key = <Control><Alt><Super>p
...
[core]
s0_active_plugins = core;composite;opengl;resize;grid;compiztoolbox;snap;move;commands;mousepoll;imgpng;unitymtgrabhandles;wall;regex;vpswitch;animation;copytex;put;place;showmouse;expo;session;fade;workarounds;ezoom;scale;unityshell;
...
s0_outputs = 1920x1080+0+0;1920x1080+3840+0;1920x1080+1920+0;
